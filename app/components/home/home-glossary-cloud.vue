...
const motionTransitionDelayed = { ...motionTransition, delay: 0.06 };
</script>
		...
		<div class="relative z-10 mx-auto w-full max-w-[1440px] px-5 md:px-10 lg:px-12">
			...
			>
				...
				>
					<!-- Cursor glow -->
					<div
						class="pointer-events-none absolute z-0 hidden h-[500px] w-[500px] rounded-full transition-opacity duration-700 md:block"
					...
					<Transition name="glossary-popup">
						<div
							...
							class="pointer-events-none absolute z-30 w-[280px] rounded-2xl bg-(--glossary-tooltip-bg) p-5 shadow-2xl lg:w-[320px] lg:p-6"
							:style="popupStyle"
							role="tooltip"
						>
							...
							<p class="text-xs leading-relaxed text-white/70 lg:text-sm">
