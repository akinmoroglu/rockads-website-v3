<template>
	<div class="font-display">
		...
		<!-- Service Cards -->
		<section class="bg-muted/80 px-5 lg:px-0">
			<div class="mx-auto flex max-w-[1141px] flex-col gap-6 lg:gap-8">
				...
				<div class="grid gap-6 md:grid-cols-2 lg:gap-8">
					...
					<div
						class="border-primary-light flex flex-col rounded-2xl border bg-card p-8 lg:p-12"
					>
					...
					<!-- Growth Capacity -->
					<div
						class="border-primary-light flex flex-col overflow-hidden rounded-2xl border bg-card p-8 lg:p-12"
					>
						<BlurText
				...
				<div class="bg-surface-dark grid gap-8 rounded-2xl border border-white/10 p-8 md:grid-cols-2 lg:gap-12 lg:p-12">
					...
					<div class="flex items-center justify-center">
						<div class="relative w-full max-w-[380px]">
							...
							<div class="mt-6 flex justify-center">
								<span class="text-surface-dark inline-flex items-center gap-2 rounded-full bg-[#f3cd02] px-5 py-2.5 text-sm font-semibold">Real-time Budget Flow</span>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="mt-8 flex flex-1 items-end justify-center">
							<div class="relative w-full max-w-[300px]">
								<div class="flex flex-wrap justify-center gap-2">
									<span class="rounded-full bg-muted px-3 py-1.5 text-xs font-medium text-foreground">Layered Protection</span>
									<span class="rounded-full bg-muted px-3 py-1.5 text-xs font-medium text-foreground">Risk Control</span>
								</div>
								...
								<div class="flex flex-wrap justify-center gap-2">
									<span class="rounded-full bg-chart-2 px-3 py-1.5 text-xs font-medium text-white">Front-line Defense</span>
									<span class="rounded-full bg-primary px-3 py-1.5 text-xs font-medium text-primary-foreground">Platform Peace</span>
								</div>
								<div class="mt-2 flex justify-center">
									<span class="bg-surface-dark rounded-full px-3 py-1.5 text-xs font-medium text-white">Media Hygiene</span>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- Dashboard -->
		<section class="bg-muted/80 px-5 pt-12 pb-12 lg:px-0 lg:pt-20 lg:pb-20">
			<div class="border-primary-light mx-auto grid max-w-[1140px] gap-8 rounded-2xl border bg-card p-8 md:grid-cols-[380px_1fr] lg:gap-12 lg:p-12">
				<div class="flex flex-col">
					<h2 class="text-text-base text-2xl leading-tight font-medium lg:text-[32px]">
						Rockads Dashboard
					</h2>
		...
		<section class="bg-background px-5 py-16 lg:py-20">
			<div class="mx-auto max-w-[800px] text-center">
				<h2 class="text-text-base text-[32px] leading-[1.2] font-semibold lg:text-[40px]">
					Built for growth that holds.<br><span class="text-foreground">Discuss Your Growth Plan</span>
				</h2>
				<Button
					as-child
					size="lg"
		...
		<!-- Stable. Enduring. Limitless. (aligned with home footer hero / Figma) -->
		<section class="core-closing relative overflow-hidden px-5 py-20 lg:py-28">
			<div
				...
				aria-hidden="true"
			>
				<div class="core-closing-ellipse size-full rounded-full" />
			</div>
			<div class="relative z-10 mx-auto flex max-w-[492px] flex-col items-center gap-9 text-center">
				<p class="text-sm leading-5 text-(--core-closing-kicker) lg:text-base">
				...
				<h2 class="w-full max-w-[536px] text-white">
					...
					<p class="text-[40px] leading-[48px] md:text-[52px] md:leading-[60px] lg:text-[68px] lg:leading-[72px]">
						<em class="core-closing-enduring text-(--core-closing-accent)">Enduring.</em>
					</p>
					<p class="text-[40px] leading-[48px] font-normal md:text-[52px] md:leading-[60px] lg:text-[68px] lg:leading-[72px]">
						Limitless.
					</p>
				</h2>
				<p class="max-w-[372px] text-sm leading-5 text-(--core-closing-description)">
...
import { IconBuildingStore, IconCashBanknote, IconUserPlus } from "@tabler/icons-vue";
...
const fiBadges = [
	{ label: "Payments", pos: { "top": "45px", "left": "8px", "--fx": "-3px", "--fy": "4px", "--fd": "0s" }, centerY: false, icon: "<rect x=\"2\" y=\"5\" width=\"20\" height=\"14\" rx=\"2\"/><path d=\"M2 10h20\"/>" },
	{ label: "Payouts", pos: { "top": "22px", "right": "28px", "--fx": "3px", "--fy": "-4px", "--fd": "0.6s" }, centerY: false, icon: "<path d=\"M12 19V5\"/><path d=\"m5 12 7-7 7 7\"/><path d=\"M2 15h4v4H2z\"/><path d=\"M18 15h4v4h-4z\"/>" },
...
.core-closing {
	--core-closing-bg: #080b0f;
	--core-closing-kicker: #898fa5;
	--core-closing-accent: #f6ca9a;
	--core-closing-description: #9fa6bb;
	background-color: var(--core-closing-bg);
}

.core-closing-enduring {
