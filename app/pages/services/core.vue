<template>
  <div class="font-display">
    ...
    <!-- Hero -->
    <section ref="heroRef" class="relative bg-[#f7f9fb] overflow-hidden">
      <canvas ref="dotCanvas" class="absolute inset-0 w-full h-full pointer-events-none" />
      <div class="relative max-w-[1066px] mx-auto px-5 lg:px-0 pt-[140px] lg:pt-[164px] pb-12 lg:pb-16 text-center">
        <h1 class="text-[40px] md:text-[48px] lg:text-[56px] font-medium leading-[1.14]">
          <span class="text-primary">Core</span> <span class="text-text-base">Services</span>
        </h1>
        <p class="text-text-gray-dark text-base lg:text-lg font-medium mt-4 lg:mt-5">
          The Structure Behind Serious Expansion
        </p>
        <p class="text-text-base text-sm lg:text-base leading-relaxed mt-6 lg:mt-8 max-w-[1066px]">
        ...
        <button class="mt-8 lg:mt-10 bg-primary-600 text-white font-medium text-base px-6 py-3 rounded-lg hover:bg-primary transition-colors">
    ...
    <section class="bg-[#f7f9fb] px-5 lg:px-0">
      <div class="max-w-[1141px] mx-auto flex flex-col gap-6 lg:gap-8">

        <!-- Row 1: Financial Infrastructure + Growth Capacity -->
        <div class="grid md:grid-cols-2 gap-6 lg:gap-8">
          <!-- Financial Infrastructure -->
          <div class="rounded-2xl border border-primary-light p-8 lg:p-12 flex flex-col" style="background-color: #F8F9FB;">
            <h2 class="text-2xl lg:text-[32px] font-medium leading-tight text-text-base">Financial Infrastructure</h2>
            <p class="text-text-gray-dark text-base lg:text-lg font-medium mt-3">Resilient foundations. Zero friction.</p>
            <p class="text-text-base text-sm lg:text-base leading-relaxed mt-5">
            ...
            <div class="mt-6 flex-1 flex items-end justify-center pb-2">
              <div class="fi-illustration">
                ...
                <div class="absolute inset-0 flex items-center justify-center z-10">
                  <div class="fi-center-circle">
                    ...
                    <svg class="w-[56px] h-[56px] relative z-10" viewBox="-1 -1 24.3 28.5" fill="white" style="margin-left: -5px;">
                ...
                >
                  <svg class="fi-badge-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" v-html="b.icon" />
                  <span>{{ b.label }}</span>
                </div>
              </div>
            </div>
          ...
          <!-- Growth Capacity -->
          <div class="rounded-2xl border border-primary-light p-8 lg:p-12 flex flex-col overflow-hidden" style="background-color:#F8F9FB;">
            <BlurText text="Growth Capacity" class="text-2xl lg:text-[32px] font-medium leading-tight text-text-base" />
            <p class="text-text-gray-dark text-base lg:text-lg font-medium mt-3">Scale without ceilings.</p>
            <p class="text-text-base text-sm lg:text-base leading-relaxed mt-5">
            ...
            <div class="mt-6 flex-1 flex items-end justify-center">
              <div class="gc-globe-wrap">
                <!-- Globe hemisphere arcs -->
                <svg class="gc-globe-svg" viewBox="0 0 522 326" fill="none">
                  <!-- Dot pattern for globe surface -->
                  <defs>
                    <clipPath id="gcClip"><rect x="0" y="30" width="522" height="296" /></clipPath>
                  </defs>
                  <g clip-path="url(#gcClip)">
                    <!-- Outer arc -->
                    <ellipse cx="261" cy="343" rx="304" ry="304" stroke="#c5d8f0" stroke-width="1" fill="none" stroke-dasharray="3 6" />
                    <!-- Middle arc -->
                    <ellipse cx="261" cy="343" rx="241" ry="241" stroke="#c5d8f0" stroke-width="1" fill="none" stroke-dasharray="3 6" />
                    <!-- Inner arc -->
                    <ellipse cx="261" cy="343" rx="167" ry="167" stroke="#c5d8f0" stroke-width="1" fill="none" stroke-dasharray="3 6" />
                    <!-- Latitude lines -->
                    <ellipse cx="261" cy="343" rx="290" ry="80" stroke="#d5e3f3" stroke-width="0.8" fill="none" stroke-dasharray="2 5" />
                    <ellipse cx="261" cy="295" rx="250" ry="60" stroke="#d5e3f3" stroke-width="0.8" fill="none" stroke-dasharray="2 5" />
                    <ellipse cx="261" cy="250" rx="195" ry="42" stroke="#d5e3f3" stroke-width="0.8" fill="none" stroke-dasharray="2 5" />
                    <ellipse cx="261" cy="210" rx="130" ry="28" stroke="#d5e3f3" stroke-width="0.8" fill="none" stroke-dasharray="2 5" />
                    <!-- Scattered dots -->
                    <g fill="#b8cce6" opacity="0.7">
                      <circle cx="90" cy="280" r="1.5"/><circle cx="120" cy="250" r="1.5"/><circle cx="150" cy="225" r="1.5"/>
                      <circle cx="80" cy="310" r="1.5"/><circle cx="110" cy="290" r="1.5"/><circle cx="140" cy="260" r="1.5"/>
                      <circle cx="170" cy="240" r="1.5"/><circle cx="195" cy="220" r="1.5"/><circle cx="220" cy="205" r="1.5"/>
                      <circle cx="245" cy="195" r="1.5"/><circle cx="270" cy="190" r="1.5"/><circle cx="295" cy="195" r="1.5"/>
                      <circle cx="320" cy="205" r="1.5"/><circle cx="345" cy="220" r="1.5"/><circle cx="370" cy="240" r="1.5"/>
                      <circle cx="395" cy="260" r="1.5"/><circle cx="420" cy="285" r="1.5"/><circle cx="440" cy="310" r="1.5"/>
                      <circle cx="100" cy="265" r="1.3"/><circle cx="130" cy="240" r="1.3"/><circle cx="160" cy="215" r="1.3"/>
                      <circle cx="190" cy="200" r="1.3"/><circle cx="215" cy="188" r="1.3"/><circle cx="250" cy="180" r="1.3"/>
                      <circle cx="280" cy="178" r="1.3"/><circle cx="310" cy="185" r="1.3"/><circle cx="340" cy="198" r="1.3"/>
                      <circle cx="365" cy="215" r="1.3"/><circle cx="390" cy="238" r="1.3"/><circle cx="415" cy="265" r="1.3"/>
                      <circle cx="435" cy="295" r="1.3"/>
                      <circle cx="135" cy="275" r="1.2"/><circle cx="165" cy="255" r="1.2"/><circle cx="200" cy="235" r="1.2"/>
                      <circle cx="230" cy="218" r="1.2"/><circle cx="260" cy="210" r="1.2"/><circle cx="290" cy="215" r="1.2"/>
                      <circle cx="325" cy="230" r="1.2"/><circle cx="355" cy="250" r="1.2"/><circle cx="380" cy="275" r="1.2"/>
                      <circle cx="405" cy="300" r="1.2"/>
                      <circle cx="175" cy="270" r="1"/><circle cx="210" cy="252" r="1"/><circle cx="245" cy="240" r="1"/>
                      <circle cx="275" cy="238" r="1"/><circle cx="305" cy="245" r="1"/><circle cx="335" cy="260" r="1"/>
                      <circle cx="365" cy="280" r="1"/><circle cx="55" cy="310" r="1.5"/><circle cx="465" cy="310" r="1.5"/>
                      <circle cx="70" cy="295" r="1.3"/><circle cx="450" cy="295" r="1.3"/>
                    </g>
                  </g>
                </svg>
                <!-- Badge pills -->
                <div class="gc-badges">
                  <div class="gc-pill">
                    <img src="/images/icons/cash-banknote-chart.svg" alt="" class="gc-pill-icon" />
                    <span>Increasing budgets</span>
                  </div>
                  <div class="gc-pill" style="margin-left:16px">
                    <img src="/images/icons/user-stop.svg" alt="" class="gc-pill-icon" />
                    <span>New accounts</span>
                  </div>
                  <div class="gc-pill" style="margin-left:20px">
                    <img src="/images/icons/store-modern.svg" alt="" class="gc-pill-icon" />
        ...
        <div class="bg-surface-dark rounded-2xl border border-white/10 p-8 lg:p-12 grid md:grid-cols-2 gap-8 lg:gap-12">
          <div class="flex flex-col">
            <h2 class="text-2xl lg:text-[32px] font-medium leading-tight text-white">Operational Continuity</h2>
            <p class="text-text-gray-light text-base lg:text-lg font-medium mt-3">Always on. No exceptions.</p>
            <p class="text-white/80 text-sm lg:text-base leading-relaxed mt-5">
            ...
            <ul class="mt-6 flex flex-col gap-3">
              <li v-for="item in opContinuityBullets" :key="item" class="flex items-start gap-3">
                <svg class="w-5 h-5 text-primary shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
          ...
          <div class="flex items-center justify-center">
            <div class="relative w-full max-w-[380px]">
              <div class="flex items-center justify-center gap-4">
                <span class="inline-flex items-center gap-2 bg-primary text-white text-sm font-medium px-4 py-2 rounded-full">Instant Top-ups</span>
                <span class="inline-flex items-center gap-2 bg-[#22c55e] text-white text-sm font-medium px-4 py-2 rounded-full">Always-On Operations</span>
              </div>
              <div class="flex justify-center mt-8">
                <div class="relative">
                  <svg class="w-24 h-24 text-primary/20" viewBox="0 0 100 100"><circle cx="50" cy="50" r="48" fill="none" stroke="currentColor" stroke-width="2"/></svg>
                  <div class="absolute inset-0 flex items-center justify-center">
                    <svg class="w-8 h-8 text-[#22c55e]" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                  </div>
                </div>
              </div>
              <div class="flex justify-center mt-6">
                <span class="inline-flex items-center gap-2 bg-[#f3cd02] text-surface-dark text-sm font-semibold px-5 py-2.5 rounded-full">Real-time Budget Flow</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-surface-dark rounded-2xl border border-white/10 p-8 lg:p-12 grid md:grid-cols-2 gap-8 lg:gap-12">
          <div class="flex items-center justify-center order-2 md:order-1">
            <div class="relative w-full max-w-[340px]">
              <span class="strat-badge" style="top:0;left:0">Direct Operational Access</span>
              <span class="strat-badge" style="top:0;right:0">Platform-Level Expertise</span>
              <div class="flex justify-center my-6">
                <div class="relative">
                  <div class="w-20 h-20 rounded-full bg-primary flex items-center justify-center">
                    <svg class="w-9 h-9 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                  </div>
                  <div class="absolute -left-10 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-[#f3cd02]" />
                  <div class="absolute -right-10 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-[#22c55e]" />
                </div>
              </div>
              <span class="strat-badge" style="bottom:0;left:0">Pazara Özel Strateji</span>
              <span class="strat-badge" style="bottom:0;right:0">True Partnership</span>
            </div>
          </div>
          <div class="flex flex-col order-1 md:order-2">
            <h2 class="text-2xl lg:text-[32px] font-medium leading-tight text-white">Strategic Support</h2>
            <p class="text-text-gray-light text-base lg:text-lg font-medium mt-3">Partnership in practice.</p>
            <p class="text-white/80 text-sm lg:text-base leading-relaxed mt-5">
            ...
            <ul class="mt-6 flex flex-col gap-3">
              <li v-for="item in strategicBullets" :key="item" class="flex items-start gap-3">
                <svg class="w-5 h-5 text-primary shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                <span class="text-text-gray-light text-sm lg:text-base">{{ item }}</span>
              </li>
            </ul>
        ...
        <div class="grid md:grid-cols-2 gap-6 lg:gap-8">
          <!-- Ecosystem Alignment -->
          <div class="bg-white rounded-2xl border border-primary-light p-8 lg:p-12 flex flex-col">
            <h2 class="text-2xl lg:text-[32px] font-medium leading-tight text-text-base">Ecosystem Alignment</h2>
            <p class="text-text-gray-dark text-base lg:text-lg font-medium mt-3">Connected by design.</p>
            <p class="text-text-base text-sm lg:text-base leading-relaxed mt-5">
            ...
            <ul class="mt-6 flex flex-col gap-3">
              <li v-for="item in ecosystemBullets" :key="item" class="flex items-start gap-3">
                <svg class="w-5 h-5 text-primary shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
            ...
            <div class="mt-8 flex-1 flex items-end">
              <div class="grid grid-cols-3 gap-4 w-full">
                <div v-for="p in ecosystemLogos" :key="p.name" class="flex items-center justify-center h-12">
                  <img :src="p.src" :alt="p.name" class="h-7 opacity-60" />
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Integrity Framework -->
          <div class="bg-white rounded-2xl border border-primary-light p-8 lg:p-12 flex flex-col">
            <h2 class="text-2xl lg:text-[32px] font-medium leading-tight text-text-base">Integrity Framework</h2>
            <p class="text-text-gray-dark text-base lg:text-lg font-medium mt-3">Built to last.</p>
            <p class="text-text-base text-sm lg:text-base leading-relaxed mt-5">
            ...
            <ul class="mt-6 flex flex-col gap-3">
              <li v-for="item in integrityBullets" :key="item" class="flex items-start gap-3">
                <svg class="w-5 h-5 text-primary shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                <span class="text-text-gray-dark text-sm lg:text-base">{{ item }}</span>
              </li>
            </ul>
            <div class="mt-8 flex-1 flex items-end justify-center">
              <div class="relative w-full max-w-[300px]">
                <div class="flex flex-wrap justify-center gap-2">
                  <span class="text-xs font-medium text-text-gray-dark bg-[#f0f4f8] px-3 py-1.5 rounded-full">Layered Protection</span>
                  <span class="text-xs font-medium text-text-gray-dark bg-[#f0f4f8] px-3 py-1.5 rounded-full">Stable Systems</span>
                </div>
                <div class="flex justify-center my-4">
                  <div class="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center">
                    <svg class="w-7 h-7 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                  </div>
                </div>
                <div class="flex flex-wrap justify-center gap-2">
                  <span class="text-xs font-medium text-white bg-[#22c55e] px-3 py-1.5 rounded-full">Built Control</span>
                  <span class="text-xs font-medium text-white bg-primary px-3 py-1.5 rounded-full">Platform-Aware</span>
                </div>
                <div class="flex justify-center mt-2">
                  <span class="text-xs font-medium text-text-gray-dark bg-[#f0f4f8] px-3 py-1.5 rounded-full">Proactive Defense</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <!-- Dashboard -->
    <section class="bg-[#f7f9fb] px-5 lg:px-0 pt-12 lg:pt-20 pb-12 lg:pb-20">
      <div class="max-w-[1140px] mx-auto bg-white rounded-2xl border border-primary-light p-8 lg:p-12 grid md:grid-cols-[380px_1fr] gap-8 lg:gap-12">
        <div class="flex flex-col">
          <h2 class="text-2xl lg:text-[32px] font-medium leading-tight text-text-base">Rockads Dashboard</h2>
          <p class="text-text-gray-dark text-lg font-medium mt-3 italic">Every service. One screen. Full control.</p>
          <p class="text-text-base text-sm lg:text-base leading-relaxed mt-5">
          ...
          <ul class="mt-6 flex flex-col gap-3">
            <li v-for="item in dashboardBullets" :key="item" class="flex items-start gap-3">
              <svg class="w-5 h-5 text-primary shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
              <span class="text-text-gray-dark text-sm lg:text-base">{{ item }}</span>
            </li>
          </ul>
        ...
        <div class="flex items-start justify-center">
          <div class="w-full rounded-xl overflow-hidden border border-gray-200 shadow-lg">
            <div class="bg-[#1e1e2e] px-4 py-2.5 flex items-center gap-2">
              ...
              <div class="flex-1 mx-8">
                <div class="bg-[#2d2d3f] rounded-md px-3 py-1 text-center">
                  <span class="text-gray-400 text-xs">console.rockads.com/</span>
                </div>
              </div>
            </div>
            <div class="bg-white p-4 lg:p-6">
              <div class="flex items-center justify-between mb-4">
                <span class="text-text-base font-semibold text-sm">Dashboard</span>
                <div class="flex gap-2">
                  <div class="w-7 h-7 rounded-full bg-gray-100" />
                </div>
              </div>
              <div class="grid grid-cols-4 gap-3 mb-4">
                <div class="bg-gray-50 rounded-lg p-3">
                  <span class="text-[10px] text-text-gray-dark block">Total Spend (USD)</span>
                  <span class="text-base font-semibold text-text-base">$58.29K</span>
                </div>
                <div class="bg-gray-50 rounded-lg p-3">
                  <span class="text-[10px] text-text-gray-dark block">Impressions</span>
                  <span class="text-base font-semibold text-text-base">257,29K</span>
                </div>
                <div class="bg-gray-50 rounded-lg p-3">
                  <span class="text-[10px] text-text-gray-dark block">Clicks</span>
                  <span class="text-base font-semibold text-text-base">39,8K</span>
                </div>
                <div class="bg-gray-50 rounded-lg p-3">
                  <span class="text-[10px] text-text-gray-dark block">Conversion</span>
                  <span class="text-base font-semibold text-text-base">1267</span>
                </div>
              </div>
              <div class="bg-gray-50 rounded-lg p-4 h-[140px] flex items-end">
                <svg class="w-full h-[100px]" viewBox="0 0 400 80" fill="none" preserveAspectRatio="none">
                  <path d="M0 60 C50 55, 80 50, 120 45 S180 30, 220 35 S280 20, 320 25 S370 15, 400 10" stroke="#1f71ea" stroke-width="2" fill="none"/>
                  <path d="M0 60 C50 55, 80 50, 120 45 S180 30, 220 35 S280 20, 320 25 S370 15, 400 10 V80 H0 Z" fill="url(#chartGrad)" opacity="0.15"/>
                  <defs><linearGradient id="chartGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1f71ea"/><stop offset="100%" stop-color="#1f71ea" stop-opacity="0"/></linearGradient></defs>
                </svg>
              </div>
            </div>
          </div>
    ...
    <!-- CTA -->
    <section class="bg-white py-16 lg:py-20 px-5">
      <div class="max-w-[800px] mx-auto text-center">
        <h2 class="text-[32px] lg:text-[40px] font-semibold leading-[1.2] text-text-base">
    ...
    <section class="bg-surface-darker py-20 lg:py-28 px-5 relative overflow-hidden">
      <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div class="w-[600px] h-[400px] rounded-full bg-white/[0.03] blur-[120px]" />
      </div>
      <div class="relative max-w-[800px] mx-auto text-center">
        <p class="text-text-gray text-sm lg:text-base font-semibold tracking-[4.8px] uppercase">
          THE ONLY PARTNER YOU'LL EVER NEED.
        </p>
        <h2 class="mt-8 lg:mt-10 text-[48px] lg:text-[68px] font-normal leading-[1.06]">
          <span class="text-white">Stable.</span><br />
          <span class="text-accent-orange italic font-display">Enduring.</span><br />
          <span class="text-white">Limitless.</span>
        </h2>
        <p class="mt-6 lg:mt-8 text-text-gray-light text-sm leading-relaxed max-w-[272px] mx-auto">
