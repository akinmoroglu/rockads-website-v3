...
const BRANDS_INPUT_DIR = path.resolve(ROOT, "app/assets/brands");
const BRANDS_OUTPUT_DIR = path.resolve(ROOT, "app/components/icons/brands");

const INPUT = CONVERT_BRANDS ? getArg(["--input", "-i"], path.resolve(ROOT, "app/assets/brands")) : USER_INPUT;
const OUTPUT = CONVERT_BRANDS ? getArg(["--output", "-o"], path.resolve(ROOT, "app/components/icons/brands")) : USER_OUTPUT;
